...
<div id="main_container">
	...
	<div id="main_content">
		<?php if($status=="Installed"): ?>
			<?php if (!$key_changed): ?>
				<p class="shj_error">
					It seems that the file <code>application/config/config.php</code> is not writable.<br>
					So you should change the encryption key manually.<br>
					Open <code>application/config/config.php</code> and change the encryption key in this line:<br>
					<pre>$config['encryption_key'] = '919RgokTjymS34AhPzF76tcLjTVYMV8T';</pre><br>
